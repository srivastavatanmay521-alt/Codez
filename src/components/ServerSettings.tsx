  ...
  return (
    ...
    <div className="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar text-white bg-transparent">
      <div className="max-w-3xl space-y-8">
        ...
        {canManage ? (
          <>
            {server.type !== "DISCORD_BOT" && <div className="bg-black/40 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-3xl shadow-[0_0_40px_-15px_rgba(0,0,0,0.5)] ring-1 ring-white/5 relative z-30 group hover:bg-black/60 transition-colors mb-8">
